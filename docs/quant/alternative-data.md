...
- **市场规模爆发**：全球另类数据市场规模从 2018 年的约 15 亿美元增长到 2025 年预计超过 50 亿美元
- **技术门槛形成护城河**：处理另类数据需要强大的数据工程和 AI 能力，小玩家难以竞争
- 据 AlternativeData.org 统计，超过 60% 的对冲基金已在使用另类数据
...
**停车场计数**：
- 使用高分辨率卫星图像（如 DigitalGlobe，分辨率 0.3-0.5 米）
- 计算机视觉（CV）算法检测车辆数量
- 与历史数据对比，预测零售商业绩
...
- SEC 关于另类数据使用的监管指引（2019 年 Staff Statement）

...
> 把互联网的控制权从大公司手中夺回来，还给用户

## 概述

Web3 是基于[区块链](/fintech/blockchain)技术的下一代互联网愿景。它的核心理念是"去中心化"（Decentralization），让用户拥有自己的数据、身份和资产，而不是依赖科技巨头提供的中心化平台。

互联网演进简史：

- **Web1**（1990s-2004）：只读互联网，用户只能浏览内容，代表产品是 Yahoo、新浪
- **Web2**（2004-至今）：可读可写互联网，用户创造内容，但平台控制数据和变现，代表产品是 Facebook、微信、抖音
- **Web3**（2020s-）：可读可写可拥有（Read-Write-Own），用户拥有自己的数据和资产，代表产品是 Uniswap、OpenSea、Lens Protocol

Web3 概念由以太坊联合创始人 Gavin Wood 于 2014 年首次提出。

## 为什么重要

- **数据主权**（Data Sovereignty）：用户真正拥有自己的数据，而非平台。数据存储在去中心化网络中，用户通过私钥控制
- **价值互联网**：价值可以像信息一样自由流动，无需中介。[比特币](/fintech/bitcoin)和[稳定币](/fintech/stablecoin)实现全球即时价值转移
- **开放金融**：[DeFi](/fintech/defi)让金融服务无需中介即可运行，任何人可参与
...
- [智能合约](/fintech/smart-contract)：业务逻辑
- DApp（去中心化应用）：用户交互界面
- 协议：DeFi、社交、游戏、存储等
...
| 治理方式   | 公司决策               | 社区投票（[DAO](/fintech/dao)） |
| 抗审查性   | 低                     | 高                              |
| 用户体验   | 优秀                   | 待提升                          |
...
- Web3 的核心技术包括区块链、[智能合约](/fintech/smart-contract)、去中心化存储
...
- [DeFi](/fintech/defi)：去中心化金融是 Web3 的核心应用
- [NFT](/fintech/nft)：NFT 是 Web3 中数字资产的确权方式
- [DAO](/fintech/dao)：DAO 是 Web3 的组织治理形式
- [元宇宙](/fintech/metaverse-finance)：Web3 为元宇宙提供经济基础设施
- [智能合约](/fintech/smart-contract)：Web3 应用的运行基础

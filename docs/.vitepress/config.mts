    ...
    themeConfig: {
      nav: [
        ...
        },
        {
          ...
          link: '/glossary/index',
          activeMatch:
            '^/(basics|money-banking|investing|derivatives|corporate-finance|macro|personal-finance|fintech|international|economics|finance-theory|financial-history|regulation|investment|quant|glossary)/',
          items: [
            {
              text: '📊 市场与投资',
              items: [
        ...
        '/glossary/': [
          {
            text: '金融百科',
            collapsed: false,
            items: [{ text: '词条总览', link: '/glossary/index' }]
          }
        ],
        '/learning-path/': [
          {

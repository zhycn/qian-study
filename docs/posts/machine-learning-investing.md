---
title: 机器学习投资
description: 机器学习投资就是让算法当基金经理，从海量数据中自动寻找规律并不断自我学习优化，能处理非线性关系和另类数据，比人类更快发现市场中的赚钱机会
category: quant
---

# 机器学习投资

机器学习投资就像"让AI当基金经理"——用算法从海量数据中自动寻找规律,不断自我学习和优化,比人类更快地发现市场中的赚钱机会。
...
- [过拟合](/posts/overfitting) - 机器学习投资中最需要防范的风险
- [深度学习与量化](/posts/deep-learning-quant) - 深度学习是机器学习的子领域
- [另类数据](/posts/alternative-data) - 机器学习特别擅长处理另类数据
- [因子投资](/posts/factor-investing) - 机器学习可用于因子挖掘和因子组合
- [策略衰减](/posts/strategy-decay) - ML 模型同样面临策略衰减问题
- [黑箱与可解释性](/posts/black-box-explainability) - ML 模型的可解释性是重要议题

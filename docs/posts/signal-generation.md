---
title: 信号生成
description: 信号生成是量化交易核心环节，从海量数据中提炼买卖指示。信息系数衡量预测力，IC 大于 0.05 即有价值。信号会随时间衰减，多信号组合能提高胜率
category: quant
---
...
- **"A 股信号与美股通用"**：A 股需结合政策因子、资金流向信号和情绪信号，不能直接套用美股模型

## 中国视角

A 股信号生成的特殊性：

- **政策信号**：A 股受政策影响显著，政策信号（如"国九条"、降准降息、行业监管政策）对短期走势影响巨大。量化模型需纳入政策因子
- **资金流向信号**：A 股北向资金（外资）流向是重要的市场信号，北向资金持续流入通常预示市场上涨（来源：万得）
- **情绪信号**：A 股散户占比高，市场情绪指标（如融资融券余额、涨停板数量、百度股票搜索指数）的预测价值高于美股
- **财报季效应**：A 股财报披露有固定时间窗口（4 月年报、7-8 月中报），财报超预期/不及预期的信号在 A 股更有效

对 A 股量化投资者：建议结合"基本面信号 + 资金流向信号 + 情绪信号"多信号组合，降低单一信号的衰减风险。

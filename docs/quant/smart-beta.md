...
> 不满足于传统指数基金"按市值买"的笨办法，但又不想付主动管理的高费用？Smart Beta 就是答案
...
- 全球 Smart Beta ETF 管理规模已超过 1.5 万亿美元
- 填补了被动和主动之间的"甜点区"——比被动多赚一点，比主动便宜很多
- 透明且规则化：策略规则公开透明，不像主动基金那样依赖基金经理的个人能力
- 费用低廉：管理费率通常 0.15% 到 0.40%，远低于主动基金的 0.50% 到 1.50%
...
**经典五因子模型**（Fama-French 5-Factor Model）：
...
|------|-------------|----------|-------------|----------|
| 红利加权 | 股息收益 + 价值效应 | 低波动 | 震荡市、熊市 | 0.06%-0.25% |
| 低波动 | 低波动异象 | 最低 | 熊市、高波动 | 0.15%-0.30% |
| 价值加权 | 价值溢价 | 中高 | 经济复苏期 | 0.15%-0.30% |
| 质量加权 | 质量溢价 | 中 | 不确定环境 | 0.15%-0.30% |
| 动量加权 | 动量效应 | 高 | 趋势市 | 0.15%-0.30% |
| 多因子 | 因子分散 | 中 | 全周期 | 0.20%-0.40% |
...
- [因子投资](/quant/factor-investing) - Smart Beta 的本质就是因子投资的 ETF 化
- [指数投资](/investment/index-investing) - Smart Beta 是指数投资的增强版
- [资产配置](/personal-finance/asset-allocation) - Smart Beta 可作为资产配置的工具
- [投资组合优化](/quant/portfolio-optimization) - 低波动 Smart Beta 本质上是最小方差优化
- [策略衰减](/quant/strategy-decay) - Smart Beta 因子的超额收益也在衰减

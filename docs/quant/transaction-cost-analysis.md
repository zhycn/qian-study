---
title: 交易成本分析
description: 滑点、手续费、冲击成本，量化交易的"隐形杀手"
---

# 交易成本分析

> 你以为 10 块钱买的股票，实际成本可能是 10.05 块——这些"隐形成本"会悄悄吃掉你的利润。
...
- [回测](/quant/backtesting)：回测必须纳入交易成本才能反映真实收益
- [信号生成](/quant/signal-generation)：信号频率和持仓周期受交易成本约束
- [执行算法](/quant/execution-algorithms)：执行算法的目标就是最小化交易成本
- [流动性](/basics/liquidity)：流动性直接影响交易成本的大小
- [量化投资流程](/quant/quant-workflow)：TCA 是量化投资流程中的关键环节

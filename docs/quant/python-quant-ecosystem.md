...
- [什么是量化投资](/quant/what-is-quant) - Python 是实现量化投资最常用的编程语言
- [回测](/quant/backtesting) - Backtrader、Zipline 等库是回测的主要工具
- [量化交易平台](/quant/quant-platforms) - 大多数平台底层基于 Python 生态构建
- [因子投资](/quant/factor-investing) - pandas 是因子计算和分析的核心工具
- [机器学习投资](/quant/machine-learning-investing) - Scikit-learn 是 ML 投资的基础工具
- [量化风险管理](/quant/quant-risk-management) - PyPortfolioOpt 等库用于风险度量

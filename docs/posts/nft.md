---
title: NFT
description: 非同质化代币就是给数字资产发身份证，让一张可以无限复制的图片变成独一无二能证明归属的收藏品，基于区块链技术的数字产权凭证让创作者获得持续版税
category: fintech
---

# NFT

NFT 就是给数字资产发"身份证"——让一张可以无限复制的图片，变成独一无二、能证明归属的收藏品。

## 概述

NFT（Non-Fungible Token）即"非同质化代币"，是基于[区块链](/posts/blockchain)技术的一种数字资产凭证。与[比特币](/posts/bitcoin)等加密货币不同，NFT 的每个单位都是独一无二的，不能互相替换。

NFT 的核心价值在于"确权"：它可以证明某张数字图片、某段音乐、某个游戏道具的归属权，就像房产证证明房子的归属一样。

2021 年 NFT 市场爆发，数字艺术家 Beeple 的作品《Everydays: The First 5000 Days》在佳士得拍卖行以 6930 万美元成交（来源：佳士得拍卖行），引发全球关注。
...
- NFT 通过[智能合约](/posts/smart-contract)中的唯一标识符（Token ID）确保每个代币的独特性
...
- NFT 可在[智能合约](/posts/smart-contract)中设置版税比例（通常 2.5-10%）
- 每次转售时，创作者自动获得版税收入
...
- [Web3](/posts/web3)：NFT 是 Web3 生态的重要基础设施
- [元宇宙](/posts/metaverse-finance)：NFT 是元宇宙中数字资产的确权工具
- [DeFi](/posts/defi)：NFT 金融化催生了 NFT 抵押借贷等新业务
- [DAO](/posts/dao)：NFT 持有者社区常以 DAO 形式治理

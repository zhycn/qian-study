---
title: 量化风险管理
description: 量化风险管理就是给高速行驶的赛车装上刹车和防撞栏，收益是面子风险是里子，止损仓位控制风险预算缺一不可，没有风控跑得越快死得越惨
category: quant
---

# 量化风险管理

量化风险管理就是给高速行驶的赛车装上刹车和防撞栏——收益是面子，风险是里子，没有风控的策略跑得越快死得越惨。
...
- [波动率](/posts/risk-return) - 波动率是风险管理的核心输入参数
- [杠杆](/posts/margin-trading) - 杠杆放大收益的同时也放大风险
- [VaR](/posts/quant-risk-management) - 风险价值是最常用的风险度量工具
- [对冲](/posts/hedging) - 对冲是风险管理的重要手段
- [资产配置](/posts/asset-allocation) - 资产配置是风险管理的顶层设计
- [过拟合](/posts/overfitting) - 过拟合策略在实盘中风险更大
- [流动性](/posts/liquidity) - 流动性风险是量化策略面临的隐性风险

## 中国投资者特别提示

- **A 股涨跌停限制**：A 股有 10%/20% 涨跌停限制，止损可能无法及时执行
- **T+1 交易制度**：当日买入无法当日卖出，增加了日内风险管理难度
- **流动性风险**：小盘股可能出现流动性枯竭，无法按预期价格平仓
- **政策风险**：A 股受政策影响较大，需关注宏观政策变化对策略的影响
- **建议**：个人投资者应设置比机构更严格的风控线，留足安全边际

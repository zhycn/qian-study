...
> 从数据中找到买卖时机的量化指标——就像天气预报说"明天降水概率 80%"，你据此决定带伞。
...
- [回测](/quant/backtesting)：信号生成后必须通过回测验证有效性
- [Alpha 与 Beta](/quant/alpha-beta)：优质信号的目标是捕获 Alpha 收益
- [交易成本分析](/quant/transaction-cost-analysis)：信号频率需要考虑交易成本的约束
- [因子投资](/quant/factor-investing)：因子是信号的重要来源
- [机器学习](/quant/machine-learning-investing)：机器学习正在成为信号生成的新工具
